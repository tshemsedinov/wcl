...
wcl.AjaxDataSource = function(params) {
	this.params = params;
	...
	this.create = function(params, callback) { this.request('create', params, callback); }
...
wcl.MemoryDataSource = function(params) {
...
wcl.Record = function(params) { // { source:DataSource, data:Hash, metadata:Hash }
	this.fields = {};
